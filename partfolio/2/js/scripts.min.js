...
$(document).ready(function(){$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],offCanvas:{position:"right"}});var e=$("#my-menu").data("mmenu");e.bind("open:start",function(){$(".hamburger").addClass("is-active")}),e.bind("close:before",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-services").owlCarousel({loop:!0,nav:!1,smartSpedd:500,responsiveClass:!0,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),$(".reviews").owlCarousel({loop:!0,items:1,smartSpedd:700,nav:!1}),$(".partners-carousel").owlCarousel({loop:!0,smartSpedd:700,dots:!1,nav:!0,responsiveClass:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsive:{480:{items:1},768:{items:2},992:{items:3},1200:{items:4}}}),$("#select-beast").selectize({create:!0})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});